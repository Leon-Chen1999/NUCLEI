...
parse_t: nuclei.c linked.c general.c nuclei.h lisp.h general.h
	$(GCC) nuclei.c linked.c general.c $(RELEASE)  -o parse_t $(LIBS) $(GCOV)

all: parse parse_s parse_v interp interp_s interp_v

interp: nuclei.c linked.c general.c nuclei.h lisp.h general.h
	$(CC) nuclei.c linked.c general.c $(RELEASE) -DINTERP -g -o interp $(LIBS)
...
interp_t: nuclei.c linked.c general.c nuclei.h lisp.h general.h
	$(GCC) nuclei.c linked.c general.c $(RELEASE) -DINTERP -o interp_t $(LIBS) $(GCOV)

extension: nuclei.c linked.c general.c nuclei.h lisp.h general.h
	$(CC) nuclei.c linked.c general.c $(RELEASE) -DINTERP -g -o extension $(LIBS)
...
runall : ./parse ./interp_s $(PRES) $(IRES)
...
clean:
	rm -f parse parse_s parse_v interp interp_s interp_v  interp_t parse_t $(PRES) $(IRES) *.gcda *.gcno *.out
